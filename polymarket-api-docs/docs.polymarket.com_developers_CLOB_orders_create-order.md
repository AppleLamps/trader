...
# [​](https://docs.polymarket.com/developers/CLOB/orders/create-order\#create-and-place-an-order)  Create and Place an Order
...
### [​](https://docs.polymarket.com/developers/CLOB/orders/create-order\#request-payload-parameters)  Request Payload Parameters
...
### [​](https://docs.polymarket.com/developers/CLOB/orders/create-order\#post-only-orders)  Post-only orders
...
### [​](https://docs.polymarket.com/developers/CLOB/orders/create-order\#order-types)  Order types
...
### [​](https://docs.polymarket.com/developers/CLOB/orders/create-order\#response-format)  Response Format
...
### [​](https://docs.polymarket.com/developers/CLOB/orders/create-order\#insert-error-messages)  Insert Error Messages
...
#### [​](https://docs.polymarket.com/developers/CLOB/orders/create-order\#error)  Error
...
### [​](https://docs.polymarket.com/developers/CLOB/orders/create-order\#insert-statuses)  Insert Statuses
...
#### [​](https://docs.polymarket.com/developers/CLOB/orders/create-order\#status)  Status
