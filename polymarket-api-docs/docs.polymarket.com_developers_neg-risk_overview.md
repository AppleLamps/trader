...
## [​](https://docs.polymarket.com/developers/neg-risk/overview\#augmented-negative-risk)  Augmented Negative Risk
...
### [​](https://docs.polymarket.com/developers/neg-risk/overview\#original-outcomes)  Original Outcomes

- Outcome A
- Outcome B
- …

### [​](https://docs.polymarket.com/developers/neg-risk/overview\#placeholder-outcomes)  Placeholder Outcomes

- Person A -> can be clarified to a named outcome
- Person B -> can be clarified to a named outcome
- …

### [​](https://docs.polymarket.com/developers/neg-risk/overview\#explicit-other)  Explicit Other
